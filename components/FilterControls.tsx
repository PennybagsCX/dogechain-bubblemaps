...
import { Save, FolderOpen, Trash2, ChevronDown, ChevronUp, Tag } from "lucide-react";
import {
  useFilters,
  HoldingSizeFilter,
  LabelFilter,
...
/**
 * Filter controls panel content.
 * Renders the actual filter UI (no portal, no overlay, no header).
 * The parent (FilterModal) handles portal/overlay/header.
 */
export const FilterControls: React.FC<FilterControlsProps> = ({ onClose: _onClose }) => {
