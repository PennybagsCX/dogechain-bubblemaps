    ...
    <nav className="sticky top-0 z-50 w-full border-b border-space-700 bg-space-900/95 backdrop-blur-md">
      <div className="w-full flex h-16 items-center justify-between px-4">
        ...
        <div className="hidden md:flex items-center gap-2">
          <button onClick={() => onChangeView(ViewState.HOME)} className={navClass(ViewState.HOME)}>
            <Search size={18} />
            <span>Search</span>
          </button>
          <button 
          ...
          <button onClick={() => onChangeView(ViewState.DASHBOARD)} className={navClass(ViewState.DASHBOARD)}>
        ...
        <div className="flex items-center gap-4">
          {userAddress ? (
            ...
            >
                {isConnecting ? <Loader2 size={16} className="animate-spin" /> : <WalletIcon size={16} />}
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden border-t border-space-700 bg-space-800 px-4 py-4 flex flex-col gap-2 absolute w-full shadow-2xl animate-in slide-in-from-top-5 z-50">
           <button onClick={() => handleMobileNav(ViewState.HOME)} className={mobileNavClass(ViewState.HOME)}>
           ...
           <button onClick={() => handleMobileNav(ViewState.DASHBOARD)} className={mobileNavClass(ViewState.DASHBOARD)}>
