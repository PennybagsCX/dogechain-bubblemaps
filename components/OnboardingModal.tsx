 ...
 *
 * A multi-step modal that guides new users through the platform's key features.
...
/**
 * Interface for OnboardingModal props
 */
...
export const OnboardingModal: React.FC<OnboardingModalProps> = ({
  ...
  const step = onboardingContent.steps[currentStep];
          ...
          <button
            ...
            aria-label={
              currentStep === totalSteps - 1
                ? "Complete onboarding and start exploring"
                : "Go to next step"
            }
          >
            {step.primaryAction}
