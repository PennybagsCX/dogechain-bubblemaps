/**
 * WalletDetailsGuide Component
 *
 * A multi-step modal guide for the wallet details sidebar (right panel) of the Map Analysis page.
 * Covers basic features (steps 1-3) and advanced features (steps 4-6).
 * Triggers when wallet sidebar first opens.
 */

import React, { useEffect, useRef } from "react";
import ReactDOM from "react-dom";
import { X } from "lucide-react";
import { Wallet, Coins, GitBranch, Bell, Tag, Download } from "lucide-react";

/**
 * Interface for WalletDetailsGuide props
 */
export interface WalletDetailsGuideProps {
  isOpen: boolean;
  currentStep: number;
  totalSteps: number;
  progress: number;
 ...
 */
const walletDetailsGuideSteps = [
  {
    id: "welcome",
    title: "Welcome to Wallet Details",
    icon: <Wallet size={48} className="text-amber-500" />,
    content:
      "View detailed information about the selected wallet. Track holdings, connections, and activity patterns.",
  ...
  },
  {
    ...
    icon: <Coins size={48} className="text-blue-500" />,
    content:
      "See exactly how many tokens this wallet holds. Compare to other holders and total supply to understand influence.",
    primaryAction: "Next",
  ...
  },
  {
    ...
    icon: <GitBranch size={48} className="text-purple-500" />,
    content:
      "View recent transactions showing tokens flowing in and out. Click any connection to see transaction details.",
    primaryAction: "Next",
    secondaryAction: "Skip",
  },
  {
    ...
    content:
      "Create alerts to track this wallet's movements. Get notified when whales buy or sell large amounts.",
    primaryAction: "Create Alert",
    secondaryAction: "Skip",
  },
  {
    id: "labeling-wallets",
    title: "Labeling Wallets",
    icon: <Tag size={48} className="text-green-500" />,
    content:
      "Add custom labels to wallets (Whale, Exchange, Team). Labels help identify key players in your analysis.",
    primaryAction: "Next",
    secondaryAction: "Skip",
  },
  {
    ...
    content:
      "Export this wallet's data for deeper analysis. Download transaction history and holdings as CSV files.",
 ...
 * WalletDetailsGuide Component
 */
export const WalletDetailsGuide: React.FC<WalletDetailsGuideProps> = ({
  isOpen,
  currentStep,
  totalSteps,
  progress,
  ...
  const step = walletDetailsGuideSteps[currentStep];
  ...
  return ReactDOM.createPortal(
    ...
    >
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="wallet-details-guide-title"
        aria-describedby="wallet-details-guide-content"
      ...
      >
        ...
        <div className="p-4 sm:p-6 border-b border-space-700">
          ...
          <div className="flex justify-end mb-2">
            <button
              ...
              aria-label="Close wallet details guide"
            >
              <X size={20} />
            </button>
          </div>
        ...
        <div className="p-6">
          ...
          {/* Description */}
          <p
            id="wallet-details-guide-content"
        ...
        <div className="px-6 pb-6 flex gap-3 justify-center">
          ...
          {step.secondaryAction && (
            <button
              ...
              aria-label="Skip wallet details guide"
            >
              {step.secondaryAction}
            </button>
          )}
